...
![alert.gif](https://upload-images.jianshu.io/upload_images/3333500-ef85c0d7fac82d02.gif?imageMogr2/auto-orient/strip)

    2. 系统Action Sheet样式的底部弹窗
     ![actionSheet.gif](https://upload-images.jianshu.io/upload_images/3333500-883a30916fa8eafd.gif?imageMogr2/auto-orient/strip)

    3. 将一个view显示到指定的位置
    ![point.gif](https://upload-images.jianshu.io/upload_images/3333500-a732de76512fc390.gif?imageMogr2/auto-orient/strip)

    4. 将一个view从frame1动画到frame2
    ![frame.gif](https://upload-images.jianshu.io/upload_images/3333500-a496b8b520f694b0.gif?imageMogr2/auto-orient/strip)

    5. 动画自定义，提供block将自定义动画传入即可
    ![cunstom.gif](https://upload-images.jianshu.io/upload_images/3333500-ecce4c7717e16cd3.gif?imageMogr2/auto-orient/strip)
